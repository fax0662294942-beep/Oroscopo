...
self.addEventListener("fetch",function(e){
  if(e.request.url.indexOf("googleapis.com")!==-1||e.request.url.indexOf("fonts.")!==-1||e.request.url.indexOf("unpkg.")!==-1){e.respondWith(fetch(e.request));return;}
